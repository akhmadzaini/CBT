              ...
              <tbody>
                ...
                <?php foreach($ujian as $r):?>
                  <tr>
                    ...
                    <td><?=$r->tgl?></td>
                    <td>
                      <form class="form-inline" method="post" action="?d=proktor&c=alat&m=submit_unggah_nilai_essay" enctype="multipart/form-data">
                        <div class="form-group">
                          <input type="hidden" name="ujian_id" value="<?=$r->ujian_id?>">
                          <input type="file" name="file_nilai" class="form-control" required>
